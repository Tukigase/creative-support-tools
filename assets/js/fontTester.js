document.addEventListener('DOMContentLoaded', () => {
    ...
    const fonts = [
        ...
        { name: 'Zen Kaku Gothic New', css: "'Zen Kaku Gothic New', sans-serif", id: "Zen+Kaku+Gothic+New:wght@400;700" },
        { name: 'Zen Maru Gothic', css: "'Zen Maru Gothic', sans-serif", id: "Zen+Maru+Gothic:wght@400;700" },
        ...
        { name: 'Shippori Mincho', css: "'Shippori Mincho', serif", id: "Shippori+Mincho:wght@400;700" },
        ...
        { name: 'Kiwi Maru', css: "'Kiwi Maru', serif", id: "Kiwi+Maru:wght@400;500" },
        { name: 'Yuji Syuku', css: "'Yuji Syuku', serif", id: "Yuji+Syuku" },
        { name: 'DotGothic16', css: "'DotGothic16', sans-serif", id: "DotGothic16" },
        { name: 'Dela Gothic One', css: "'Dela Gothic One', cursive", id: "Dela+Gothic+One" },
        { name: 'RocknRoll One', css: "'RocknRoll One', sans-serif", id: "RocknRoll+One" },
        { name: 'Reggae One', css: "'Reggae One', cursive", id: "Reggae+One" },
        { name: 'Train One', css: "'Train One', cursive", id: "Train+One" },
        { name: 'Hachi Maru Pop', css: "'Hachi Maru Pop', cursive", id: "Hachi+Maru+Pop" }
    ];

    // ★追加：JSでGoogle Fontsを自動読み込み
    const fontQuery = fonts.map(f => `family=${f.id}`).join('&');
